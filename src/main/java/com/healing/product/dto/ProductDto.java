...
public class ProductDto {
	...
	public void setProduct_price_adult(int product_price_adult) {
		this.product_price_adult = product_price_adult;
	}
	public int getProduct_price_child() {
		return product_price_child;
	}
	public void setProduct_price_child(int product_price_child) {
		this.product_price_child = product_price_child;
	}
	public int getProduct_price_baby() {
		return product_price_baby;
	}
