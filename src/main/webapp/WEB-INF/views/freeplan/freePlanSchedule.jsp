...
<body onload="initSchedule('${root}','${freePlanList[0].place_city}')">
	...
	<div class="city_dialog">
		...
		<div class="city_category">
			<img src="http://localhost:8181/main/resources/freePlanImg/place.png" id="place_btn" onclick="clickCategory(this,'${freePlanList[0].place_city}','${root}')" style="cursor:hand;"/>
			<img src="http://localhost:8181/main/resources/freePlanImg/restaurant.png" id="rest_btn" onclick="clickCategory(this,'${freePlanList[0].place_city}','${root}')" style="cursor:hand;"/>
			<img src="http://localhost:8181/main/resources/freePlanImg/hotel.png" id="hotel_btn" onclick="clickCategory(this,'${freePlanList[0].place_city}','${root}')" style="cursor:hand;"/>
		</div>
