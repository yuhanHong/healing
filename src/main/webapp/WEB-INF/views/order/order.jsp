...
<!-- 				<h1 style="">예약</h1> -->
			...
			<div class="productSummary">
				<div style="padding-bottom: 20px; margin: 15px 15px 15px 15px; border-bottom: 1px solid #D1D1D1;">
					<div style="border:1px #ffffff solid; width:100%; height:150px;overflow:hidden;" id="product${productDto.product_number}" class="clearfix on">
						<div style="float:left; margin-left: 30px;"><img width="204" height="150" alt="상품이미지" src="${root}/resources/productPhoto/${productDto.product_number}/0-1-1.jpg"></div>
						
						<div class="details">
								<h3 style="padding: 0 0 10px 0; font-weight: bold;">[ATP${productDto.product_number}] ${productDto.product_name}</h3>
			...
			<div id="orderAllDiv">
					...
					<div class="orderDiv" style="margin-top: 30px;">
						<b style="font-size: 15px;margin-left: 110px;">결제 예정 금액 :   
				...
				<br/><br/><br/>
				<div id="tabs" class="orderDiv" style="margin-left: 20px; width:910px;">
					 <ul>
			...
			<div class="orderDiv" style="margin-left: 420px;">
