...
<body>
	<form id="orderForm" action="${root}/order/write.do"  method ="post" onsubmit="return orderCheck(this,'${root}')">
		...
		<div class="orderDiv">
			...
			<label>예약자 명 :</label>  <input type="text" name="order_name" size="10"/>
			<label>전화번호 :</label>  <input type="text" name=order_phone size="10"/>
		</div>
		<div class="orderDiv">
			<label>이메일  :</label>  <input type="text" name="order_email" />
		</div>
		<div class="orderDiv">
			<label>출발 날짜  :</label>
		...
		<div class="orderDiv">
			<label>성인 인원 : </label> <input id="order_adult" type="number"  value="0" name="order_adult " max="20" min="1" size="2">
			<label>아동 인원 : </label><input id="order_child" type="number"  value="0" name="order_adult " max="20" min="0" size="2">
			<label>유아 인원 : </label> <input id="order_baby" type="number"  value="0" name="order_adult " max="20" min="0" size="2">
		</div>

		<div class="orderDiv" >
			<label>결제 방법 : </label> 
			<input type="radio" name="payment_option" value="card" ><label>카드</label>
			<input type="radio" name="payment_option" value="cash" ><label>무통장 입금</label>
		</div>
		<div class="orderDiv">
