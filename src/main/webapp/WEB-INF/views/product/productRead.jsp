...
<link rel="stylesheet" href="${root}/css/product/Modetour/Itinerary.css?ver=20151222" type="text/css">
<link rel="stylesheet" href="${root}/css/product/Modetour/warp.css" type="text/css">
<link rel="stylesheet" href="${root}/css/product/Modetour/product.css" type="text/css" />
		...
		<div id="content">
			<div class="nav">
				...
				<ul>
					...
					<li>&nbsp;&gt;&nbsp; <a href="${root}/product/productList.do?pc=${pc}">${product_category}</a></li>
					<c:if test="${product_category!=productDto.product_country}">
						<li>&nbsp;&gt;&nbsp; <a href="${root}/product/productList.do?pc=${pc}">${productDto.product_country}</a></li>
					</c:if>
					<li>&nbsp;&gt;&nbsp; <a href="${root}/product/productList.do?pc=${pc}">${product_city}</a></li>
				</ul>
			</div>
			...
			<div id="ItineraryTable" class="itinerary_table">
				<div class="schedule_info clearfix" style="height: 300px;">
					<div style="float: left; height: 300px;">
						<a href="#top" onclick="product_photo_view(); return false;"><img src="${root}/resources/productPhoto/${productDto.product_number}/0-1-1.jpg" width="410" height="278" /></a>
					</div>
					<div style="float: left; width: 450px; height: 300px; margin: 0px 20px;">
						<div class="code_wrap" style="padding: 10px 0px; border-bottom: 1px solid #666666;">
					...
					<div class="iti_contents">
						<div class="itinerary">
							...
							<div class="summary_table" style="z-index: 2;">
								...
								<table summary="상품 요약 정보">
									<tbody>
										...
										<tr>
											<th>교통편</th>
											<td><img src="${root}/resources/icons/airline/airline_${flightDto.flight_start_airline}.gif" style="width: 22px;" onerror="this.style.display='none';" />${flightDto.flight_start_airline}</td>
										</tr>
										<tr>
											<th>여행기간</th>
											<td>
												<div class="terms">${productDto.product_stay_days}박 ${productDto.product_days}일 [기내 ${productDto.product_days-1-productDto.product_stay_days}일숙박]</div>
												<ul class="period_list">
													<li><span ><b class="hidden">한국출발&nbsp;</b></span><span class="text"><strong><fmt:formatDate value="${flightDto.flight_start_departure}" type="both" pattern="yyyy년 M월 d일 (E) HH:mm" /></strong></span></li>
													<li><span ><b class="text">현지도착&nbsp;</b></span><span class="text"><fmt:formatDate value="${flightDto.flight_start_arrival}" type="both" pattern="yyyy년 M월 d일 (E) HH:mm" /></span></li>
													<li><span ><b class="text">현지출발&nbsp;</b></span><span class="text"><fmt:formatDate value="${flightDto.flight_end_departure}" type="both" pattern="yyyy년 M월 d일 (E) HH:mm" /></span></li>
													<li><span ><b class="hidden">한국도착&nbsp;</b></span><span class="text"><strong><fmt:formatDate value="${flightDto.flight_end_arrival}" type="both" pattern="yyyy년 M월 d일 (E) HH:mm" /></strong></span></li>
												</ul>
										...
										<tr id="ContentMain_ContentPlaceHolder_Pnl_MeetBox">
											...
											<td>
												<div class="meeting">
													<strong><fmt:formatDate value="${flightDto.flight_start_departure}" timeZone="GMT+07" type="both" pattern="HH:mm" /></strong> 인천국제공항 3층 출국장 <br/>F와G 카운터 사이 중앙엘리베이터 옆 힐링투어 1번~8번 전용테이블 앞
												</div>
											</td>
										</tr>
									</tbody>
							...
							<div class="cost_info">
								<div class="tabs">
									...
									<div id="cost_price" class="contents">
											...
											<div class="tables">
												<table>
													...
													<tbody>
														...
														<tr class="ess">
															<th rowspan="1" scope="row" class="cost_must"><div class="b_wrap">
																	<i></i><br/>현지 필수 경비
																</div></th>
										...
										<div class="notify">
											<p class="change_info">* 현지필수경비란? 현지에서 별도로 지불해야 하는 필수 경비입니다. 하단의 불포함 사항 내역을 확인해주시기 바랍니다.</p>
											<p class="change_info">* 상기 여행 요금 및 유류할증료, 제세공과금은 유가와 환율에따라 인상 또는 인하 될 수 있습니다.</p>
											<p></p>
											...
											<br/> * 가격은 성인기준으로 2인 1실입니다.<br/>아동, 유아요금은 성인과 한방 사용기준입니다.<br/>
											<br/>상품 특성상 추가 경비가 있을 수 있으니, 아래 불포함 사항을 확인해 주시기 바랍니다.[예약금규정]예약 후 3일 이내에 여행경비의 10% 이상을 결제하셔야 합니다.<br/>* 위 예약금은 특별약관 및 항공, 호텔, 현지 사정 등에 의하여 예약금 납입 시한이 단축되거나 인상될 수 있습니다.
										</div>
									</div>
							...
							<div class="marketing_ad">
								<div class="long_ad">
									<a href="#top" onclick="window.open('/Popup/Discount/DiscountBookingCheck.aspx?flag=K&Choice=748&Gubun=1&gubun2=5&pw=0&ph=0&url=/Popup/Discount/DiscountLink/LotteOnline.aspx&sd=2014.01.07&ed=2015.12.31','LotteEvent',''); return false;" title="새창"> 
									</a>
								</div>
								<div style="margin-top: 5px;">
									<ul class="sort_ad">
										<li class="left"><a href="http://www.modetour.com/Board/Support/NoticeView.aspx?mloc=1701&idx=8126" target="_blank"></a>
										</li>
										<li class="right"><a href="http://shopping.modetour.co.kr/dc/" target="_blank"></a>
										</li>
									</ul>
								</div>
							</div>
							<div id="privilege" class="privilege">
								<div class="inclusive clearfix">
									<div class="include">
										<h3>
											<img src="http://img.modetour.co.kr/modetour/2014/itinerary/hn_include.png" alt="포함사항" />
										</h3>
										<div class="contents">
											<div id="ContentMain_ContentPlaceHolder_Pnl_Inclusion">①왕복항공권<br/>②인천공항세,관광진흥개발기금,현지공항세,전쟁보험료<br/>③숙박비, 식사비(일정표참고), 차량비<br/>④1억원 여행자 보험<br/>⑤한국인 가이드와 함께 미팅/센딩 서비스<br/><br/><br/>※ 여행자보험 담당 : [동부화재] 원부미(보험관련문의만가능) <br/>Tel)02-728-8006 Fax)02-2021-7800 <br/>- 단 15세 미만의 사망보험금 및 만 79세 6개월 이상의 질병사망에 대해서는 보험 약관에 따라 보험금이 지급되지 않습니다. <br/>-자세한 세부사항은 홈페이지 하단 여행보험을 참조 바랍니다.</div>
										</div>
									</div>
									<div class="exclude">
										<h3>
										...
										<div class="contents">
											<div id="ContentMain_ContentPlaceHolder_Pnl_NonInclusion">&nbsp;<br/>① (현지가이드/기사경비)는 전일정 $${productDto.product_guide_adult}/1인(아동동일)을 현지에서 지불해야 합니다.<br/>② 일정표내 명시된 불포함 식사<br/>③ 기타 개인경비<br/>&nbsp;<br/>&nbsp;<br/></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div style="clear:both"></div>
								...
								<div class="etc_links">
									<a href="#top" onclick="Itinerary_Popup('/w3c/TravelAgreementOverseas1.aspx', '', 'width=780px,height=783px'); return false;" class="tour_terms"><span class="blind">여행약관</span></a> <a href="#" class="tour_homepage"><span class="blind">해외안전 여행 홈페이지</span></a>
								</div>
			...
			<div id="InsuranceManager" style="display: none;">※ 여행자보험 담당 : [동부화재] 원부미(보험관련문의만가능) <br/> Tel)02-728-8006 Fax)02-2021-7800 <br/>- 단 15세 미만의 사망보험금 및 만 79세 6개월 이상의 질병사망에 대해서는 보험 약관에 따라 보험금이 지급되지 않습니다. <br/>- 자세한 세부사항은 홈페이지 하단 여행보험을 참조 바랍니다.</div>
