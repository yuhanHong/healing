...
<body>
   ...
   <br/><br/>
	<a href = "${root}/boardNotice/write.do">Notice 게시판 write</a><br/>
	<a href = "${root}/boardNotice/list.do">Notice 게시판 list</a><br/><br/>
	
	<a href = "${root}/boardFaq/write.do">FAQ 게시판 write</a><br/>
	<a href = "${root}/boardFaq/list.do">FAQ 게시판 list</a><br/><br/>
	
	<a href = "${root}/boardQna/write.do">Q&A 게시판 write</a><br/>
	<a href = "${root}/boardQna/list.do">Q&A 게시판 list</a><br/>
</body>
</html>