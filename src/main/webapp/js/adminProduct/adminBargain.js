function bargainFormCheck(form){
	...
	if (form.bargain_day1.value!=null && form.bargain_day1.value>0 && form.bargain_rate1.value!=null && form.bargain_rate1.value>0 && form.bargain_day2.value!=null && form.bargain_day2.value>0 && form.bargain_rate2.value!=null && form.bargain_rate2.value>0 && form.bargain_day1.value<=form.bargain_day2.value) {
